...
class MethodChannelVideoPlayer extends VideoPlayerPlatform {
    ...
    switch (dataSource.sourceType) {
      ...
      case DataSourceType.network:
        dataSourceDescription = <String, dynamic>{
          ...
          'liveTargetOffsetMs': dataSource.liveTargetOffsetMs,
        };
        break;
  ...
  @override
  Future<int> getLiveOffset(int? textureId) async {
    // Crinza patch — see VideoPlayerPlatform.getLiveOffset.
  ...
  @override
  Future<int> seekToLiveOffset(int? textureId, int offsetMs) async {
    // Crinza patch — see VideoPlayerPlatform.seekToLiveOffset.
    return await _channel.invokeMethod<int>(
          'seekToLiveOffset',
          <String, dynamic>{'textureId': textureId, 'offsetMs': offsetMs},
        ) ??
        -1;
  }

  @override
  Future<Map<String, dynamic>> getLiveDebugInfo(int? textureId) async {

...
// Crinza patch: live target offset (ms); 0 = platform default.
@property(nonatomic) int liveTargetOffsetMs;
...
// Crinza patch: parity with the Android fork — place the playhead a fixed
// distance behind the live edge, reading the edge at seek time.
